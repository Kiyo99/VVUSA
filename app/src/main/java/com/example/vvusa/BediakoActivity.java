                    ...
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                ArrayAdapter<String> arrayAdapterGF = new ArrayAdapter<>(BediakoActivity.this, android.R.layout.simple_spinner_item, numbers);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                ArrayAdapter<String> arrayAdapterSF = new ArrayAdapter<>(BediakoActivity.this, android.R.layout.simple_spinner_item, numbers);
