...
public class CateringActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd.setMessage("Loading catering posts, please wait...");
        pd.show();

        recyclerView = findViewById(R.id.Catering);
    ...
    private void EventChangeListener() {
        db.collection("Catering").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable @org.jetbrains.annotations.Nullable QuerySnapshot value, @Nullable @org.jetbrains.annotations.Nullable FirebaseFirestoreException error) {
                if (error != null){
                    pd.dismiss();
                    Log.e("Error", error.getMessage());
                    Toast.makeText(CateringActivity.this, "Error loading catering posts, please try again", Toast.LENGTH_SHORT).show();
                    return;
                }
