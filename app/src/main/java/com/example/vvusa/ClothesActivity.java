...
public class ClothesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd.setMessage("Loading Clothes, please wait...");
        pd.show();

        recyclerView = findViewById(R.id.Clothes);
    ...
    private void EventChangeListener() {
        db.collection("Clothes").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable @org.jetbrains.annotations.Nullable QuerySnapshot value, @Nullable @org.jetbrains.annotations.Nullable FirebaseFirestoreException error) {
                if (error != null){
                    pd.dismiss();
                    Log.e("Error", error.getMessage());
                    Toast.makeText(ClothesActivity.this, "Error loading Clothes, please try again", Toast.LENGTH_SHORT).show();
                    return;
                }
