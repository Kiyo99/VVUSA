...
public class NagsdaDashboard extends AppCompatActivity {

    TextView rNumber, welcome, title1, title2, title3, nagsdaTitle1, nagsdaSub1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nagsda_dashboard);
        ...
        nagsdaTitle1 = findViewById(R.id.nagsdaTitle1);
        nagsdaSub1 = findViewById(R.id.nagsdaSub1);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        nagsdaTitle1.setText(topic);
                        nagsdaSub1.setText(subtitle);

                    } else {
                        Log.d(TAG, "No such document");
                        nagsdaTitle1.setText("Nothing yet, check again later");
                    }
                } else {
                    Log.d(TAG, "get failed with ", task.getException());
                    nagsdaTitle1.setText("failed");
                }
            }
        });
    ...
    private void send() {
        pd = new ProgressDialog(NagsdaDashboard.this);
        ...
        {
            pd.dismiss();
            Toast.makeText(NagsdaDashboard.this, "All fields are required!", Toast.LENGTH_SHORT).show();
        }else{
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (document.exists()) {
                            ...
                            if (T1.equalsIgnoreCase("")) {
                                ...
                                db.collection("Hostel")
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                pd.dismiss();
                                                Toast.makeText(NagsdaDashboard.this, "Successfully sent your complaint", Toast.LENGTH_SHORT).show();
                                            }
                                        })
                                        .addOnFailureListener(new OnFailureListener() {
                                            @Override
                                            public void onFailure(@NonNull @NotNull Exception e) {
                                                Toast.makeText(NagsdaDashboard.this, "Error sending your complaint, please try again", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                ...
                                pd.dismiss();
                                Toast.makeText(NagsdaDashboard.this, "You have 3 active complaints, please wait until they are resolved or ask a roommate to send the complaint.", Toast.LENGTH_LONG).show();
                            }
                        } else {
                            Log.d(TAG, "No such document");
