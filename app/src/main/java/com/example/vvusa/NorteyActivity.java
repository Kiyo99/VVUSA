...
public class NorteyActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nortey);
...
//        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        Toast.makeText(NorteyActivity.this, "Document does not exist", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Log.d(TAG, "get failed with ", task.getException());
                    Toast.makeText(NorteyActivity.this, "Failed", Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        Apply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pd = new ProgressDialog(NorteyActivity.this);
                ...
                {
                    pd.dismiss();
                    Toast.makeText(NorteyActivity.this, "All fields are required!", Toast.LENGTH_SHORT).show();
                }
                else if (!str_acNo.equals("S" + str_ID)){
                    pd.dismiss();
                    Toast.makeText(NorteyActivity.this, "Your Account number and ID number do not correlate", Toast.LENGTH_SHORT).show();
                }
                else if (str_phoneNumber.length() < 10)
                {
                    pd.dismiss();
                    Toast.makeText(NorteyActivity.this, "Please have a valid phone number", Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    db.collection("Hostel")
                        ...
                        public void onComplete(@NonNull @NotNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful()) {
                                DocumentSnapshot document = task.getResult();
                                if (document.exists()) {
//                                                        Toast.makeText(NorteyActivity.this, "Found document", Toast.LENGTH_LONG).show();
                                    Log.d(TAG, "DocumentSnapshot data: " + document.getData());
                                    ...
                                    Toast.makeText(NorteyActivity.this, "Document not found", Toast.LENGTH_LONG).show();
                                }
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                if (document.exists()) {
                                    ...
                                    Hostel.put("Hostel", "J.J.Nortey");
                                    Hostel.put("Room Number", roomNo);

                                    db.collection("Users").document(userid)
                                            .update(Hostel);

                                    Intent intent = new Intent(NorteyActivity.this, NorteyDashboard.class);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                ArrayAdapter<String> arrayAdapterGF = new ArrayAdapter<>(NorteyActivity.this, android.R.layout.simple_spinner_item, numbers);
...
//                                room = spinnerNum.getSelectedItem().toString();
                                ...
                                Toast.makeText(NorteyActivity.this, "Error loading Rooms, please try again", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                ArrayAdapter<String> arrayAdapterSF = new ArrayAdapter<>(NorteyActivity.this, android.R.layout.simple_spinner_item, numbers);
...
//            Toast.makeText(NorteyActivity.this, "Your room number is" + roomNo, Toast.LENGTH_LONG).show();
        }
