...
public class NagsdaActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.Nagsda_floor, android.R.layout.simple_spinner_dropdown_item);
...
//        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        Toast.makeText(NagsdaActivity.this, "Document does not exist", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Log.d(TAG, "get failed with ", task.getException());
                    Toast.makeText(NagsdaActivity.this, "Failed", Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        Apply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pd = new ProgressDialog(NagsdaActivity.this);
                ...
                {
                    pd.dismiss();
                    Toast.makeText(NagsdaActivity.this, "All fields are required!", Toast.LENGTH_SHORT).show();
                }
                else if (!str_acNo.equals("S" + str_ID)){
                    pd.dismiss();
                    Toast.makeText(NagsdaActivity.this, "Your Account number and ID number do not correlate", Toast.LENGTH_SHORT).show();
                }
                else if (str_phoneNumber.length() < 10)
                {
                    pd.dismiss();
                    Toast.makeText(NagsdaActivity.this, "Please have a valid phone number", Toast.LENGTH_SHORT).show();
                }
                else{
                        ...
                        public void onComplete(@NonNull @NotNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                if (document.exists()) {
                                    ...
                                    Toast.makeText(NagsdaActivity.this, "Document not found", Toast.LENGTH_LONG).show();
                                }
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                if (document.exists()) {
                                    ...
                                    Hostel.put("Hostel", "Nagsda");
                                    Hostel.put("Room Number", roomNo);

                                    db.collection("Users").document(userid)
                                            .update(Hostel);

                                    Intent intent = new Intent(NagsdaActivity.this, NagsdaDashboard.class);
...
//            Toast.makeText(NorteyActivity.this, "Your room number is" + roomNo, Toast.LENGTH_LONG).show();
        ...
        else if (selectedItem.equalsIgnoreCase("EX")){
            floor = "EX";
            pd = new ProgressDialog(this);
            pd.setCancelable(false);
            pd.setMessage("Loading Rooms for EX, please wait...");
            pd.show();
            numbers.clear();
